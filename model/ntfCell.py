...
class ntfCell(LayerRNNCell):
  ...
  def __init__(self, num_units,
    ...
    self.max_values=tf.convert_to_tensor(max_vals)
  ...
  def call(self, inputs, state):
    ...
    unscaled_inputs = self.max_values*inputs
    m = tf.layers.dense(array_ops.concat([unscaled_inputs, m], 1),self._num_units,activation='relu')
    # m = tf.layers.dense(array_ops.concat([inputs, m],nu)
