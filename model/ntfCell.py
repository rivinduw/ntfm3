...
class ntfCell(LayerRNNCell):
  ...
  def __init__(self, num_units,
               ...
               activation=None, reuse=None, name=None, n_seg=9, dtype=None, **kwargs):
  ...
  def call(self, inputs, state):
    ...
    eq_vars = tf.reshape(ntf_matrix,[-1,self._n_seg,16])#+tf.constant(1.0)#*tf.constant(10.0,name="eq_vars")
    ...
    current_volume = unscaled_inputs[:,:,0]*tf.constant(12.0,name="q")
    ...
    prev_volume = prev_segs[:,:,0]*tf.constant(12.0,name="q")
    ...
    p_cr = eq_vars[:,:,3]*tf.constant(100.,name="pcr")#+tf.constant(1.0)# + tf.constant(33.5,name="p_cr")
    ...
    next_flows = tf.divide(tf.multiply(next_rho,next_vel),tf.constant(12.0))
