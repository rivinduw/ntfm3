...
def model_fn(mode, inputs, params, reuse=False):
    ...
    if is_training:
        optimizer = tf.train.AdamOptimizer(params.learning_rate)#RMSPropOptimizer(0.001)#AdamOptimizer(params.learning_rate)#tf.train.GradientDescentOptimizer(0.001)#
