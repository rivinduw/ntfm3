...
#training.py does the running of the graph on some data
...
def train_and_evaluate(train_model_spec, eval_model_spec, model_dir, params, restore_from=None):
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(begin_at_epoch, begin_at_epoch + params.num_epochs):
            ...
            num_steps = (params.train_size + params.batch_size - 1) // (params.batch_size*params.window_shift)#1024#
            ...
            num_steps = (params.eval_size + params.batch_size - 1) // (params.batch_size*params.window_shift+params.window_size)
