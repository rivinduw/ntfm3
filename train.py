...
if __name__ == '__main__':
    ...
    params.restore_dir= None#"experiments/last_weights"#None#"experiments/best_weights"#"experiments/last_weights"#None#args.restore_dir#"experiments/best_weights"#None#
