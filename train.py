...
if __name__ == '__main__':
    ...
    train_y = load_dataset_from_csv(filenames = ["data/train/SH1N30s2-out-1.csv"])#["data/SH1N30s2c.csv"])#["data/labels/SH1N30s2c.csv"])
    # train_labels = load_dataset_from_csv()#load_dataset_from_csv(path_train_labels)
    eval_x = load_dataset_from_csv(filenames = ["data/test/SH1N30s2-in-1.csv"])#["data/eval/SH1N30s2c-in.csv"])#load_dataset_from_csv(path_eval_sentences)
    eval_y = load_dataset_from_csv(filenames = ["data/test/SH1N30s2-out-1.csv"])#["data/eval/SH1N30s2c-out.csv"])
...
<<<<<<< HEAD
    params.restore_dir= "experiments/last_weights"#None#args.restore_dir#"experiments/best_weights"#None#
=======
    params.restore_dir= None#args.restore_dir#"experiments/best_weights"#None#
